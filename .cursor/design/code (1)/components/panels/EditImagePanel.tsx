...
const EditImagePanel: React.FC<EditImagePanelProps> = ({ canvasContent, onContentUpdate, api, isLoading }) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold mb-2">Editar Imagem</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <Textarea
          id="edit-prompt"
          label="Instrução de Edição Personalizada"
          value={prompt}
        ...
        />
        <Button type="submit" disabled={isLoading || !prompt.trim() || !isImageOnCanvas} className="w-full">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center">
          <span className="bg-gray-800/50 px-2 text-sm text-gray-400">Ações Rápidas</span>
        </div>
      </div>
