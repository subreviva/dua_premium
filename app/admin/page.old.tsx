...
import { 
  Users, Coins, Activity, Shield, Plus, Loader2, 
  Edit, Trash2, RefreshCw, Lock, Unlock, Search, 
  TrendingUp, Database, Clock, ChevronDown
} from "lucide-react";
          ...
          <div className="group relative overflow-hidden bg-gradient-to-br from-pink-500/10 to-pink-600/5 border border-pink-500/20 rounded-xl p-6 hover:border-pink-500/40 transition-all">
            ...
            <div className="relative">
              ...
              <p className="text-xs text-gray-500 mt-1">
                {((allUsers.filter(u => u.subscription_tier !== 'free').length / allUsers.length) * 100).toFixed(1)}% conversion
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 space-y-3">
                    <div className="grid md:grid-cols-2 gap-3">
                      ...
                      <select
                        ...
                        className="bg-black/50 border border-white/10 rounded-lg px-3 py-2 text-sm h-10"
                        disabled={processing}
                      >
                        <option value="free">Free</option>
                        <option value="basic">Basic</option>
