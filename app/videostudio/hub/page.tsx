...
import { Film, ImagePlay, Wand2, ArrowUpCircle, Sparkles, ArrowRight, Users } from "lucide-react"
  ...
  const tools = [
    {
      ...
      features: ["Duração 5-10s", "6 proporções", "Gen4 Turbo"],
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-white/40 font-light mt-1">
                  Crie Vídeos Profissionais com IA • 4 Ferramentas Poderosas
                </p>
              </div>
            </div>
          </div>
