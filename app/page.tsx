      ...
      <section className="relative min-h-screen sm:h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-5 sm:px-6 lg:px-8 h-full flex items-center justify-center">
          <div className="flex flex-col gap-2 sm:gap-6 md:gap-8 lg:gap-12 items-center justify-center max-w-7xl w-full mx-auto text-center -mt-32 sm:mt-0">
            ...
            >
              <p className="text-[10px] sm:text-sm md:text-base text-white/60 font-light tracking-wider">
            ...
            {/* Tagline - Alinhamento Flow perfeito */}
            <motion.p
              initial={{ opacity: 0, y: 15 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.2, ease: [0.22, 1, 0.36, 1] }}
              className="text-[13px] sm:text-lg md:text-xl lg:text-2xl text-white/85 font-light max-w-[260px] sm:max-w-3xl leading-tight sm:leading-relaxed px-5 sm:px-8"
              style={{ 
            ...
            {/* Botões Flow - Design premium centralizado */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Button
                size="lg"
                className="flex-1 sm:flex-none sm:w-auto rounded-full px-5 sm:px-10 py-[9px] sm:py-4 bg-white text-black hover:bg-white/90 active:bg-white/80 font-medium text-[11.5px] sm:text-base transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-[0_2px_8px_rgba(0,0,0,0.15)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.2)] border-0 whitespace-nowrap"
              ...
              <Button
                size="lg"
                variant="outline"
                className="flex-1 sm:flex-none sm:w-auto rounded-full px-5 sm:px-10 py-[9px] sm:py-4 bg-transparent hover:bg-white/10 active:bg-white/5 text-white font-medium text-[11.5px] sm:text-base transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] border border-white/40 hover:border-white/60 shadow-[0_2px_8px_rgba(0,0,0,0.1)] whitespace-nowrap"
