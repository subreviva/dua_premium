...
export default function ImageStudioWelcome() {
  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      ...
      if (session?.user) {
        ...
        router.push('/imagestudio/create');
      } else {
  ...
  const handleEnter = () => {
    ...
    router.push('/login?redirect=/imagestudio');
  };
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      >
        <source
          src="https://4j8t2e2ihcbtrish.public.blob.vercel-storage.com/transferir%20%2856%29.mp4"
          type="video/mp4"
        />
      </video>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
        ...
        >
          ...
          >
            Crie imagens profissionais com inteligência artificial
          </motion.p>
