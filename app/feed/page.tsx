...
import { Music, ImageIcon, Video, PanelLeftClose, PanelLeft, Heart, MessageCircle, Share2 } from "lucide-react"
...
const mockMusic = [
  {
    id: "1",
    albumArt: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=800&q=80",
...
export default function FeedPage() {
  ...
  useEffect(() => {
    ...
    // In production, replace with real authentication check
    const checkAuth = () => {
      // For now, assume user is authenticated if they accessed via chat
      // In production, use proper auth state management
    ...
    return (
      <div className="relative w-full min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center space-y-4">
          <h1 className="text-4xl font-bold text-white">Feed Personalizado</h1>
          <p className="text-white/70">Faça login para ver o seu feed personalizado</p>
          <Button
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
          <div className="space-y-2">
            <h1 className="text-4xl font-bold text-white">Seu Feed Personalizado</h1>
            <p className="text-white/70">Conteúdo dos criadores que você segue</p>
          </div>
          ...
          <Tabs defaultValue="todos" className="w-full">
            <TabsList className="bg-black/40 backdrop-blur-xl border border-white/10">
              ...
              <TabsTrigger value="musica" className="gap-2">
            ...
            <TabsContent value="todos" className="mt-6">
              <div className="text-center py-12 text-white/70">
                <p>Siga criadores para ver o conteúdo deles aqui</p>
                <Button
            ...
            <TabsContent value="imagem" className="mt-6">
              <MasonryGrid items={mockImages}>{(image) => <ImageCard image={image} />}</MasonryGrid>
            </TabsContent>

            <TabsContent value="musica" className="mt-6">
              <div className="grid grid-cols-1 gap-4">
                {mockMusic.map((music) => (
                  <MusicPlayerCard key={music.id} music={music} />
                ))}
              </div>
            </TabsContent>

            <TabsContent value="video" className="mt-6">
              <MasonryGrid items={mockVideos}>{(video) => <VideoCard video={video} />}</MasonryGrid>
            </TabsContent>
          </Tabs>
        </div>
      </div>
