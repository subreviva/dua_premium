...
import { Palette, Coins, User, MessageSquare, LogOut, ShoppingCart } from "lucide-react"
...
export function DesignStudioNavbar() {
  ...
  const handleLogout = async () => {
    try {
      ...
      console.error('[DESIGN NAVBAR] Erro ao fazer logout:', error)
    }
  }
